...
plt.savefig("Results/Exp3_1_Compare_1000/inp_out.pdf", dpi = 3000, bbox_inches='tight')
plt.show()
...
plt.yticks(fontsize=12)
plt.savefig("Results/Exp3_1_Compare_1000/model.pdf", dpi = 3000, bbox_inches='tight')
plt.show()
