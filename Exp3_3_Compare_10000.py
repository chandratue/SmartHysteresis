...
plt.savefig("Results/Exp3_3_Compare_10000/inp_out.pdf", dpi = 3000, bbox_inches='tight')
plt.show()
...
plt.yticks(fontsize=12)
plt.savefig("Results/Exp3_3_Compare_10000/model.pdf", dpi = 3000, bbox_inches='tight')
plt.show()
