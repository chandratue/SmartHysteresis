...
plt.savefig("Results/Exp3_2_Compare_5000/inp_out.pdf", dpi = 3000, bbox_inches='tight')
plt.show()
...
plt.yticks(fontsize=12)
plt.savefig("Results/Exp3_2_Compare_5000/model.pdf", dpi = 3000, bbox_inches='tight')
plt.show()
